...
namespace SignalR.API_FoodAPI.Controllers
{
    ...
    public class ProductController : ControllerBase
    {
        ...
        [HttpGet("DateSaleProductInOrder")]
        public IActionResult DateSaleProductInOrder(string date)
        {
            var values = _productService.BDateSaleProductInOrder(date);
            return Ok(values);
        }
        [HttpGet("GetWeeklySalesReport")]
